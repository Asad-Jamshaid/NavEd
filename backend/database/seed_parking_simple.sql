-- ==========================================
-- Simple Parking Data Seed Script
-- This script temporarily disables RLS, inserts data, then re-enables it
...
-- Disable RLS temporarily (only for this session)
ALTER TABLE public.parking_lots DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.parking_history DISABLE ROW LEVEL SECURITY;

-- ==========================================
-- STEP 2: Insert Parking Lots
-- ==========================================
...
ON CONFLICT (id) DO UPDATE SET
  ...
  disabled_parking_spots = EXCLUDED.disabled_parking_spots,
...
-- ==========================================
-- STEP 3: Insert Parking History Data
-- ==========================================

-- A Parking (park-1) - Monday 8 AM - Peak hour (90% occupancy)
...
-- Additional data points - Thursday and Friday
INSERT INTO public.parking_history (parking_lot_id, day_of_week, hour, occupancy, created_at) VALUES
-- A Parking - Thursday

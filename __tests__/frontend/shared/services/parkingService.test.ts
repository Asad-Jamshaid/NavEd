...
// Mock database services to use AsyncStorage fallback
...
jest.mock('../../src/services/parkingDatabaseService', () => ({
  ...
  saveParkedVehicleToDb: jest.fn(() => Promise.resolve(true)),
  getParkedVehicleFromDb: jest.fn(() => Promise.resolve(null)),
  clearParkedVehicleFromDb: jest.fn(() => Promise.resolve(true)),
}));
